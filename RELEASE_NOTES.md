# Perspective Dieline Generator 1.0.0

This release establishes a local-first workflow from perspective package photography to confirmed measurements and editable 1:1 SVG geometry across the public web app and Windows desktop shell.
